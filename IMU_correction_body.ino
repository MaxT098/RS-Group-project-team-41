...
//#define MOTOR_PWR           50
#define MOTOR_PWR           25      // Paul: I think your robot is moving too fast
                                    //       to debug or observe properly! So I 
                                    //       reduced this.
...
float xpos_lpf = 0.0;                     // Paul: accelerometer has high freq noise, so 
                                    //       trying a crude low-pass filter. See
                                    //       Xposition();
